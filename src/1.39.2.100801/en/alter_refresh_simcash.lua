function initialization()
   ...
   menus = {
      main = {
         {"ALTER REFRESH SIMCASH", "OPEN GAMEGUARDIAN", "EXIT"}, {"🌕   ALTER REFRESH SIMCASH", "🌕   OPEN GAMEGUARDIAN", "🌕   EXIT"},
         prompt = "Choose menu: "
      }
   };
   ...
   messages = {
      ...
      neomall = {
         search_toast = "Finding NeoMall root pointer...",
         ambiguous_constant_value = "Warning: NeoMall root pointer is ambiguous, %d found",
         root_pointer_not_found = "Error: NeoMall root pointer was not found",
         parent_pointers_not_found = "Error: NeoMall parent pointer was not found",
         pointers_not_found = {
            "Error: NeoMall pointers were not found"
         }
      },
      neomall_refresh_simcash_not_found = "Error: NeoMall refresh simcash was not found",
      refresh_simcash_altered = "Succeeded to alter refresh simcash values",
      refresh_simcash_altered_already = "You have already altered refresh simcash values",
