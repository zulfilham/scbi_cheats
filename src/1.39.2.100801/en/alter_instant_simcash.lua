function initialization()
   ...
   menus = {
      main = {
         {"ALTER INSTANT SIMCASH", "OPEN GAMEGUARDIAN", "EXIT"}, {"🌕   ALTER INSTANT SIMCASH", "🌕   OPEN GAMEGUARDIAN", "🌕   EXIT"},
         prompt = "Choose menu: "
      }
   };
   ...
   messages = {
      ...
      items = {
         ...
         pointers_not_found = {
            common_items = "Error: Common items pointers were not found",
            rare_items = "Error: Rare items pointers were not found",
            omega_items = "Error: OMEGA items pointers were not found"
         }
      },
      instant_simcash_altered = "Succeeded to alter instant simcash values",
      instant_simcash_altered_already = "You have already altered instant simcash values",
