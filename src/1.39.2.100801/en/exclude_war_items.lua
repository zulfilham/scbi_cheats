function initialization()
   ...
   menus = {
      main = {
         {"EXCLUDE WAR ITEMS", "OPEN GAMEGUARDIAN", "EXIT"}, {"🌕   EXCLUDE WAR ITEMS", "🌕   OPEN GAMEGUARDIAN", "🌕   EXIT"},
         prompt = "Choose menu: "
      }
   };
   ...
   messages = {
      ...
      war_items_required_altered = "Succeeded to exclude war items",
      war_items_required_altered_already = "You have already excluded war items",
