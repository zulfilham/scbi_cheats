function initialization()
   ...
   menus = {
      main = {
         {"BEKUKAN NILAI SUMBER DAYA", "BUKA GAMEGUARDIAN", "EKSIT"}, {"🌕   BEKUKAN NILAI SUMBER DAYA", "🌕   BUKA GAMEGUARDIAN", "🌕   EKSIT"},
         prompt = "Pilih menu: "
      },
      freeze_resource_values = {
         {"PENGALAMAN", "SIMOLEON", "SIMCASH", "KUNCI EMAS", "KUNCI PLATINUM", "POIN VU", "NEOSIMOLEON", "SIMOLEON PERANG", "KEMBALI"},
         prompt = "Pilih nilai sumber daya yang ingin dibekukan: "
      }
   };
   ...
   messages = {
      ...
      resources = {
         search_toast = "Mencari petunjuk akar sumber daya...",
         ambiguous_constant_value = "Peringatan: Petunjuk akar sumber daya ambigu, %d ditemukan",
         root_pointer_not_found = "Eror: Petunjuk akar sumber daya tidak ditemukan",
         parent_pointers_not_found = "Eror: Petunjuk induk sumber daya tidak ditemukan",
         pointers_not_found = {
            "Eror: Petunjuk sumber daya tidak ditemukan"
         }
      },
      no_options_chosen = "Peringatan: Anda harus memilih minimal 1 pilihan",
      resource_values_frozen = "Berhasil membekukan nilai sumber daya",
      resource_values_frozen_already = "Anda memang sudah membekukan nilai sumber daya",
