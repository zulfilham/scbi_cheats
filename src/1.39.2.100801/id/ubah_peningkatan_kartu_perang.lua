function initialization()
   ...
   menus = {
      main = {
         {"UBAH PENINGKATAN KARTU PERANG", "BUKA GAMEGUARDIAN", "EKSIT"}, {"🌕   UBAH PENINGKATAN KARTU PERANG", "🌕   BUKA GAMEGUARDIAN", "🌕   EKSIT"},
         prompt = "Choose menu: "
      }
   };
   ...
   cache = {
      ...
      headers = "-- BERKAS INI DIHASILKAN OLEH SKRIP ubah_peningkatan_kartu_perang.lua\n-- JANGAN DIHAPUS, KARENA IA MENYIMPAN TEMBOLOK YANG DIPERLUKAN\n\nreturn "
   };
   load_cache_data();
   messages = {
      ...
      items = {
         ...
         pointers_not_found = {
            war_cards = "Eror: Petunjuk kartu perang tidak ditemukan",
            refresh_simcash = "Eror: Petunjuk simcash penyegaran ulang tidak ditemukan"
         }
      },
      war_cards_upgrade_altered = "Berhasil mengubah peningkatan kartu perang",
      war_cards_upgrade_altered_already = "Anda memang sudah mengubah peningkatan kartu perang",
