function initialization()
   ...
   menus = {
      main = {
         {"UBAH WAKTU PRODUKSI", "BUKA GAMEGUARDIAN", "EKSIT"}, {"🌕   UBAH WAKTU PRODUKSI", "🌕   BUKA GAMEGUARDIAN", "🌕   EKSIT"},
         prompt = "Pilih menu: "
      }
   };
   ...
   messages = {
      ...
      items = {
         ...
         pointers_not_found = {
            production_times = "Eror: Petunjuk waktu produksi tidak ditemukan"
         }
      },
      production_times_altered = "Berhasil mengubah nilai waktu produksi",
      production_times_altered_already = "Anda memang sudah mengubah nilai waktu produksi",
